...
Counts: **archive** 25, **learn** 6, **resource-sheet** 4, **story** 34, **whitepaper** 1 (total 70).

| slug | category | cluster |
|---|---|---|
| `3-tips-for-managing-concert-anxiety` | story | features |
| `4-lyrics-for-feeling-your-feelings` | story | features |
| `a-conversation-with-amira-elfeky` | story | interviews |
| `a-conversation-with-up-and-coming-hyperpop-artist-wsteaway` | story | interviews |
| `a-holistic-approach-to-trauma-recovery` | learn | - |
| `a-night-in-the-marias-dreamland` | archive | - |
| `a-sound-approach` | whitepaper | - |
| `an-interview-with-rising-pop-artist-rosie-darling` | story | interviews |
| `as-abortion-rights-are-under-attack-artists-fight-back` | story | features |
| `backstage-at-newport-folk-with-the-black-opry-revue` | archive | - |
| `boygenius-hit-the-road-so-i-did-too` | archive | - |
| `caring-for-your-body-in-crisis-prioritizing-respiratory-health` | resource-sheet | - |
| `check-in-series-summer-salt-reimagines-their-past-on-the-juniper-songbook-by-alyssa-goldberg` | story | interviews |
| `comfort-club-interview` | story | interviews |
| `coping-with-suicidal-ideation-in-college-tips-from-a-college-student` | learn | - |
| `donor-thanks-email` | archive | - |
| `fall-2023-round-up` | archive | - |
| `girlsonthebrink-reflection` | learn | - |
| `govball2024-claire-rosinkranz-interview` | story | interviews |
| `govball2024-hotlinetnt-interview` | story | interviews |
| `greywind-interview` | story | interviews |
| `hoja-de-recursos` | resource-sheet | - |
| `holly-humberstone-album-review` | archive | - |
| `how-to-curate-an-anxiety-soothing-playlist` | story | features |
| `i-am-tired-of-being-constantly-available` | story | features |
| `illinoise-review` | archive | - |
| `is-it-heaven-or-is-it-just-palace-at-webster-hall` | archive | - |
| `kacy-hill-performs-at-mercury-lounge-by-alyssa-goldberg` | archive | - |
| `kate-yeager-interview-2024` | story | interviews |
| `limperatrice-music-hall-of-williamsburg-review` | archive | - |
| `lyrical-analysis-of-holly-humberstones-the-walls-are-way-too-thin` | story | features |
| `maddie-zahm-interview` | story | interviews |
| `marina-herlop-finds-the-balance-between-danger-discomfort-and-stillness` | story | interviews |
| `moy-interview` | story | interviews |
| `neda-week-stigma` | resource-sheet | - |
| `nina-ljeti-interview` | story | interviews |
| `noah-kahan-interview` | story | interviews |
| `noah-kahans-stick-season-speaks-to-the-mental-health-of-young-adults-through-powerful-folk-lyrics` | story | features |
| `nuria-graham-on-music-as-a-collective-experience-and-her-journey-with-her-latest-album-majorie` | story | interviews |
| `olive-klug-interview` | story | interviews |
| `paris-paloma-the-atlantis-review` | archive | - |
| `quinn-xcii-interview` | story | interviews |
| `resource-sheet-for-evacuees-and-first-responders-of-the-2025-los-angeles-fires` | resource-sheet | - |
| `review-chappell-roan-house-of-blues-boston` | archive | - |
| `review-dean-lewis-at-td-garden` | archive | - |
| `review-del-water-gap-atlanta` | archive | - |
| `review-mac-demarco-at-webster-hall-7-19-23` | archive | - |
| `review-mod-sun-live-at-irving-plaza` | archive | - |
| `review-two-door-cinema-club-roadrunner-boston` | archive | - |
| `rock-singer-songwriter-ally-nicholas-is-being-true-to-herself` | story | interviews |
| `smino-and-jid-at-terminal-5-review` | archive | - |
| `sounds-of-saving-announces-the-formation-of-its-youth-advisory-council` | archive | - |
| `sounds-of-saving-check-in-series-field-medic-brings-emo-to-folk-music` | story | interviews |
| `spring-2023-round-up` | archive | - |
| `surf-curse-magic-hour-the-mental-toll-of-touring-and-collective-creativity` | story | interviews |
| `syml-interview-2023` | story | interviews |
| `taking-life-advice-from-shakey-graves` | story | features |
| `taylor-swift-philly-review` | archive | - |
| `the-art-of-being-seen` | story | features |
| `the-front-bottoms-fan-spotlight-it-was-a-life-saving-experience` | story | features |
| `the-last-dinner-party-at-royale-review` | archive | - |
| `tim-atlas-kicks-off-north-american-tour-at-bostons-cafe-939-q-a` | story | interviews |
| `tiny-habits-union-stage-review` | archive | - |
| `valley-lost-in-translation-interview` | story | interviews |
| `vara-interview` | story | interviews |
| `what-is-dbt` | learn | - |
| `what-is-dysthymia` | learn | - |
| `what-is-emdr` | learn | - |
| `wherever-mt-joy-is-thats-where-we-wanna-go` | archive | - |
| `winter-spring-2024-round-up` | archive | - |


## Sessions parse

- Seed: scripts/sessions-seed.json
- Episodes in seed: 37
- Content files (written or present): 37

  - sharon-van-etten-hurt.md  (jpguLriXLik)  Sharon Van Etten — Hurt
  - bartees-strange-lemonworld.md  (eCLoUHG8uEI)  Bartees Strange — Lemonworld
  - indigo-sparke-dry.md  (dMOTwpBm1x0)  Indigo Sparke — Dry
  - chai-to-be-with-you.md  (XC7GRIRqNW8)  CHAI — To Be With You
  - june-mcdoom-emerald-river-dance.md  (-m0glN0yg3U)  June McDoom — Emerald River Dance
  - walter-schreifels-dont-ask-why.md  (jvcJQwhs17g)  Walter Schreifels — Don't Ask Why
  - circuit-des-yeux-fruits-of-my-labor.md  (3iy6HehLaOg)  Circuit des Yeux — Fruits of My Labor
  - melanie-charles-i-wanna-thank-you.md  (VU1gQ2nKBv0)  Melanie Charles — I Wanna Thank You
  - jim-ward-the-luckiest.md  (4aA93p6HT6o)  Jim Ward — The Luckiest
  - geese-place-to-be.md  (guqvWfKuxRw)  Geese — Place to Be
  - xenia-rubinos-homebody.md  (t6wZSIR8-uE)  Xenia Rubinos — Homebody
  - thao-human-behaviour.md  (YDoLwnjGQf4)  Thao — Human Behaviour
  - cassandra-jenkins.md  (tnHgPmvctdM)  Cassandra Jenkins
  - kat-cunning.md  (Jh6I3pFxKho)  Kat Cunning
  - adia-victoria.md  (ymlr2TJr4Z0)  Adia Victoria
  - disturbed.md  (AEHKppmmMYs)  Disturbed
  - black-belt-eagle-scout.md  (1dkL8IdQ1R0)  Black Belt Eagle Scout
  - madison-mcferrin.md  (Jlx--tJZPUE)  Madison McFerrin
  - sean-solomon-of-moaning.md  (fXdscu1Atyc)  Sean Solomon of Moaning
  - alicia-bognanno-of-bully-dry.md  (5xI7qsO03SA)  Alicia Bognanno of Bully — Dry
  - kate-davis.md  (KT1CiGCsQL4)  Kate Davis
  - jamie-lidell.md  (cZLigJeLFFo)  Jamie Lidell
  - keiyaa.md  (nDrwTOqihB0)  KeiyaA
  - meshell-ndegeocello-good-day-bad.md  (Zvxnwsw0NTU)  Meshell Ndegeocello — Good Day Bad
  - sasami.md  (jZ6mbh1ssiQ)  Sasami
  - kyp-malone-of-tv-on-the-radio-mexico-city.md  (uFywlP0kGTQ)  Kyp Malone of TV on the Radio — Mexico City
  - vorhees-golden-hours.md  (Ye0FWyYTvK0)  Vorhees — Golden Hours
  - shilpa-ray-new-age.md  (RI-DQJVBj88)  Shilpa Ray — New Age
  - denitia-heavenly-day.md  (eyDCeCG-p9M)  Denitia — Heavenly Day
  - lrain.md  (KlH8Ndh6O6g)  L'Rain
  - brittain-ashford.md  (bYrzxoekc2E)  Brittain Ashford
  - jackie-mendoza-book-of-dreams.md  (nwU5UTqCbMU)  Jackie Mendoza — Book of Dreams
  - john-coltrane-a-love-supreme-pt-1-acknowledgement.md  (fth9UUa1Mfw)  John Coltrane — A Love Supreme, Pt. 1: Acknowledgement
  - nina-simone-who-knows-where-the-time-goes.md  (OXeh742_jak)  Nina Simone — Who Knows Where the Time Goes
  - the-pixies-monkey-gone-to-heaven.md  (XycBLF6kWuY)  The Pixies — Monkey Gone to Heaven
  - neil-young-out-on-the-weekend.md  (08ts6hekHlc)  Neil Young — Out on the Weekend
  - prince-something-in-the-water-does-not-compute.md  (LwoSyRd5ngY)  Prince — Something in the Water (Does Not Compute)
